...
const ApiMedicSymptoms = ({ navigation }) => {
  ...
  const fetchSymptoms = async () => {
    try {
      const response = await fetch(
        'https://healthservice.priaid.ch/symptoms?token=YOUR_TOKEN&format=json&language=en-gb'
      );
  ...
  const handleDiagnosis = async () => {
    ...
    try {
      ...
      const apiUrl = `https://healthservice.priaid.ch/diagnosis?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..whmQjwfhTgKeJX628a6uGiXemG6NreKq8Qd-Q9mkLuw&format=json&language=en-gb&${queryString}`;
